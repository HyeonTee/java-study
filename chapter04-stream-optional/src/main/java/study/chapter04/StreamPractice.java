 ...
 * Stream API 연습 문제.
 *
 * <p>모든 메서드는 {@code static}이며, 파라미터로 받은 컬렉션을 변경하지 않는다.
...
public class StreamPractice {
    ...
    public static List<Integer> filterEven(List<Integer> numbers) {
        throw new UnsupportedOperationException("TODO: filter + collect");
    }

    /** 모든 문자열을 대문자로 변환하여 리스트로 반환한다. */
    public static List<String> mapToUpperCase(List<String> strings) {
        throw new UnsupportedOperationException("TODO: map + collect");
    }

    /** 정수 리스트의 합을 반환한다. 빈 리스트면 0. */
    public static int sumAll(List<Integer> numbers) {
        throw new UnsupportedOperationException("TODO: mapToInt + sum 또는 reduce");
    }

    /** 리스트에서 최댓값을 Optional로 반환한다. */
    public static Optional<Integer> findMax(List<Integer> numbers) {
        throw new UnsupportedOperationException("TODO: stream().max(Comparator)");
    }

    /** 중첩 리스트를 하나로 펼치고 오름차순 정렬하여 반환한다. */
    public static List<Integer> flattenAndSort(List<List<Integer>> nested) {
        throw new UnsupportedOperationException("TODO: flatMap + sorted + collect");
    }

    /** 중복을 제거하고 입력 순서를 유지하여 반환한다. */
    public static List<Integer> uniqueElements(List<Integer> numbers) {
        throw new UnsupportedOperationException("TODO: distinct + collect");
    }

    /** 내림차순 정렬 후 상위 n개를 반환한다. n이 리스트 크기보다 크면 전부 반환. */
    public static List<Integer> topN(List<Integer> numbers, int n) {
        throw new UnsupportedOperationException("TODO: sorted(역순) + limit + collect");
    }
    ...
    public static double average(List<Integer> numbers) {
        throw new UnsupportedOperationException("TODO: mapToInt + average + orElse(0.0)");
    }
