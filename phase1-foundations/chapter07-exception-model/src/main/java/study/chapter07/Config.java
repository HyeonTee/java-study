 ...
 *
 * <p>
 * {@link #require}는 "없으면 실패"를, {@link #getInt}는 "형식이 틀리면 실패하되 원인을 보존"을 연습한다.
...
public final class Config {
     ...
     *
     * <p>
     * 힌트: {@code values.get(key)}가 {@code null}이면
     * {@code new MissingKeyException(key)}를 던지고,
     * 아니면 그 값을 반환하라.
     */
     ...
     *
     * <p>
     * 힌트: {@link #require}로 문자열을 얻은 뒤 {@link Integer#parseInt}로 변환하라.
     * {@link NumberFormatException}이 나면 그것을 catch해서
     * {@code new MalformedValueException(key, 원본문자열, e)}로 다시 던지되 —
     * <strong>cause(e)를 인자로
    ...
    public int getInt(String key) {
        ...
        try {
            ...
            throw new MalformedValueException(key, value, e);
        }
    }
}
