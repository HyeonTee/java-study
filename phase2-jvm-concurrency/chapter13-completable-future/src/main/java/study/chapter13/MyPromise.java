 ...
 *
 * <p>ch12의 {@code BlockingQueue.take()}는 결과가 올 때까지 <strong>블록</strong>했다(pull). 여기서는
 ...
 * {@link #get()}만은 ch12에서 익힌 {@code wait}/{@code notifyAll}로 완료까지 블록한다.
 *
...
public class MyPromise<T> {
    ...
    /**
     * 완료될 때까지 <strong>블록</strong>하고 값을 반환한다(ch12에서 익힌 {@code wait}/{@code notifyAll}).
