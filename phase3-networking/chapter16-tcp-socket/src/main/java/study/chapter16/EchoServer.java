 ...
 * 블로킹 방지. 자원은 try-with-resources / ch15 {@code closeAll}로 <strong>LIFO</strong> close.
 *
...
public final class EchoServer implements AutoCloseable {
     ...
     *
     * <p>힌트: {@code accept()}로 받은 {@code Socket}을 try-with-resources로 감싸라(끝나면 LIFO close — ch15
