...
public final class ConnectionPolicy {
     ...
     *
     * <p>힌트: {@code req.headers().get("connection")}(ch16 Headers 회수)을 소문자화해 판정. 버전은 {@code req.line().version()}.
     */
     ...
     *
     * <p>힌트: {@code res.headers().with("Connection", keepAlive ? "keep-alive" : "close")}(ch16 {@code Headers.with}
