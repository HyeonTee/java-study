...
public final class ConnectionPolicy {
     ...
     *
     * <p>힌트: {@code req.headers().get("connection")}(ch17 Headers 회수)을 소문자화해 판정. 버전은 {@code req.line().version()}.
     */
     ...
     *
     * <p>힌트: {@code res.headers().with("Connection", keepAlive ? "keep-alive" : "close")}(ch17 {@code Headers.with}
     ...
     * <strong>길이의 '존재 여부'만 보면 되므로 {@code get("Content-Length").isEmpty()}로 판정한다</strong> — ch17
