 ...
 *
 * <p>왜 필요한가: ch18 {@code HttpMessageWriter}는 {@code Content-Length}를 <strong>자동으로 안 붙인다</strong>(호출자
 ...
 * keep-alive의 전제).
 *
 * <p>완성 제공이지만, 내부적으로 ch18 {@link Headers#with}를 호출하므로 ch18을 풀기 전(main)에는 이 메서드들도
 * {@code UnsupportedOperationException}을 던진다 — Gradle 의존(ch18 스텁) 때문. ch18 풀이 후 동작한다.
 */
