...
import study.chapter19.core.Routable;
 ...
 * 숫자 번역은 {@code http.HttpAdapter}의 일이다. {@code method}는 ch17처럼 {@code String}(enum으로 닫지 않음 — "405는 응답
 * 단계의 결정").
 *
...
public final class Router<Req extends Routable<Req>, Res> {
    ...
    /**
     * 라우터 전체를 <strong>미들웨어로 감싸인 단일 {@link Handler}</strong>로 닫는다 — 프레임워크가 ch18
